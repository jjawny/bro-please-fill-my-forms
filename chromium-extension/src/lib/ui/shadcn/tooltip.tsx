...
function TooltipContent({
  ...
  const finalBackgroundColor = backgroundColor ?? "bg-primary";
  const finalFillColor =
    backgroundColor?.replace(/^bg-/, "fill-") ?? "fill-primary";
    ...
    <TooltipPrimitive.Portal>
      ...
      >
        ...
        <TooltipPrimitive.Arrow
          className={cn(
            "fz-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]",
            finalBackgroundColor,
            finalFillColor
          )}
        />
